...
def train():
    ...
    time_codes = make_time_latent(init=np.load('estimated_time_latent_lego_23.npy'))
    ...
    testsavedir = os.path.join('./project_results', expname, 'renderonly_{}_{:06d}'.format('test' if args.render_test else 'path', start))
